            ...
            <div class="card card-outline card-info">
              ...
              <div class="card-header">
                ...
                <div class="form-group row">
                  ...
                  <label for="codAsegurado" class="col-md-2 col-form-label">Matricula:</label>

                  <div class="col-md-3">

                    <input type="text" class="form-control mayuscula" name="codAsegurado" id="codAsegurado">
                ...
                <!-- <p><b>Matricula: </b></p>
                <p><b>Nombre o Razón Social del Empleador: </b></p>
                <p><b>Nro. Empleador: </b></p> -->
              ...
              <div class="card-body">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control mayuscula" id="nuevoPaterno" name="nuevoPaterno" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ .-]+" title="Solo deben ir letras en el campo">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="nuevoMaterno">Apellido Materno</label>
                    <input type="text" class="form-control mayuscula" id="nuevoMaterno" name="nuevoMaterno" pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ .-]+" title="Solo deben ir letras en el campo">
                  </div>

                  <div class="form-group col-md-4">
                    <label for="nuevoNombre">Nombre<span class="text-danger"> *</span></label>
                    <input type="text" class="form-control mayuscula" id="nuevoNombre" name="nuevoNombre" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ .-]+" title="Solo deben ir letras en el campo">
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label for="nuevaFechaNacimiento">Fecha de Nacimiento<span class="text-danger"> *</span></label>
                    <input type="date" class="form-control" id="nuevaFechaNacimiento" name="nuevaFechaNacimiento" required="">
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input type="text" class="form-control" id="nuevoTelefono" name="nuevoTelefono" data-inputmask="'mask': '99999999'" pattern="[-0-9]{7,8}+" title="Solo deben ir números en el campo">
                  </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control mayuscula" id="nuevaZona" name="nuevaZona" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ .-]+" title="Solo deben ir letras y números en el campo">
                  </div>

                  <div class="form-group col-md-3">
                    <label for="nuevaCalle">Calle<span class="text-danger"> *</span></label>
                    <input type="text" class="form-control mayuscula" id="nuevaCalle" name="nuevaCalle" required pattern="[A-Za-zñÑáéíóúÁÉÍÓÚ .-]+" title="Solo deben ir letras y números en el campo">
                  </div>
              ...
              <div class="card-footer">
                ...
                <div class="float-right">
                  ...
                  <input type="hidden" id="codAfiliado" name="codAfiliado" value="SIN REGISTRAR">

                  <input type="hidden" id="codEmpleador" name="codEmpleador" value="SIN REGISTRAR">
