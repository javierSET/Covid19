...
//        var_dump($localidades);
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-10 row" id="ubicacionLugarDeInfeccion">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <select class="form-control form-control-sm" name="provinciaProbableInfeccion" id="provinciaProbableInfeccion"   disabled> 
                      <option value="0">Elegir...</option>
                      <?php 
      ...
      <div class="card mb-0">
        ...
        <div class="card-body">
          ...
          <div class="form-row">
            ...
            <div class="form-inline col-md-4" id="nuevoFechaSintomatico" <?php echo $malestare['sintoma']=="ASINTOMATICO" ? 'style="display: none;"': '' ?>>
          ...
          <div class="form-row" id="divSintomas" <?php echo $malestare['sintoma']=="ASINTOMATICO" ? 'style="display: none;"': '' ?> >
          ...
          <div class="form-row" id="divSintomasEstado" <?php echo $malestare['sintoma']=="ASINTOMATICO" ? 'style="display: none;"': '' ?>>
          ...
          <div class="form-row" id="divSintomasClinico" <?php echo $malestare['sintoma']=="ASINTOMATICO" ? 'style="display: none;"': '' ?>>
          ...
          <div class="form-row">
             <div class="icheck-silver mr-5">
              ...
              <div class="form-group col-md-3">
                ...
                <input type="date" class="form-control form-control-sm" name="nuevoFechaAislamiento" id="nuevoFechaAislamiento" value="<?= $hospitalizaciones_aislamientos['fecha_aislamiento'] ?>" disabled>
              ...
              <div class="form-group col-md-3">
                ...
                <input type="date" class="form-control form-control-sm" name="nuevoFechaInternacion" id="nuevoFechaInternacion" value="<?= $hospitalizaciones_aislamientos['fecha_internacion'] ?>" disabled>
          ...
          <div class="form-row"  id="paraInternado">
                ...
                <div class="form-row col-md-12">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="date" class="form-control form-control-sm" name="nuevoFechaIngresoUTI" id="nuevoFechaIngresoUTI" value="<?= $hospitalizaciones_aislamientos['fecha_ingreso_UTI'] ?>" disabled>
      ...
      <div class="card mb-0">       
        ...
        <div class="card mb-0">
              ...
              <div class="form-row">
                ...
                <div class="form-group col-md-5">
                    <div class="checkbox icheck-turquoise">
                      <input type="checkbox" name="transferenciaHospital" value="TRANSFERENCIA A HOSPITAL" id="transferenciaHospital" <?php echo $laboratorios['transferencia_hospital_obreo']=="SI" ? 'checked':'' ?>> 
                      <label class="font-weight-normal" for="transferenciaHospital" id="transferenciaHospitalL" >TRANSFERENCIA A HOSPITAL</label>
                    </div>
                </div>
          ...
          <div class="card mb-0 fichaEpidemiologicaLaboratorio" id="idFichaEpiLaboratorioT">
              <div class="card-header bg-dark py-1 text-center">
        ...
        <div class="card mb-0">
          ...
          <div class="card-footer">
            ...
            <div class="float-right">
              ...
              <button type="button" id="btnGuardarLabl" class="btn btn-primary btnGuardarLab">
